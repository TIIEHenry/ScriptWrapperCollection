...
class ScriptDexLoader(val scriptContext: ScriptContext<*>) {
    ...
    var odexDir = scriptProvider.odexDir
    var soDir = scriptProvider.soDir
    var nativeLibraryDir = scriptProvider.nativeLibraryDir
    ...
    fun loadDex(dexFile: File): ScriptDexClassLoader? {
        ...
        if (dex == null) {
            ...
            if (dex == null) {
                dex = ScriptDexClassLoader(path, odexDir, nativeLibraryDir, scriptContext.getContext().classLoader)
